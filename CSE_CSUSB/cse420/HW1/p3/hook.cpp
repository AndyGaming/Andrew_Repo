...
/*
  ...
  //draw an arc
  surf.setColor (0xff, 0, 0);
  surf.moveTo (center.x + 120, center.y + 120);
  draw_arc ( surf, 80, 80, 210, 120 );
...
*/
  ...
  surf.moveTo (center.x - 150, center.y);
  surf.forward (300, 1);
  ...
  surf.moveTo (center.x - 150, center.y + 150);
  surf.lineTo (center.x + 150, center.y - 150);

  surf.updateSurface();
  SDL_Delay ( 2000 ); 
  surf.clearScreen();

  surf.moveTo (center.x, center.y + 150);
  surf.lineTo (center.x, center.y - 150);
